...
>>>>>>> fe31cf2848214cab6f5004de366b1b54ac373b79
const items = [
  {
...
=======
      ...
      <React.StrictMode>
                ...
                <div className="w-full  l:w-8/12 px-6">
                  <div>
                    ...
                    <p className=" text-xl leading-relaxed text-black">
                      ...
                      portfolio of services that encompasses expertise,
                      surveying, advising, training and mentoring in the sectors
                      of industry, agriculture and environment. We pride
                      ourselves on providing concrete and customized solutions
                      fully adapted to the specific needs of our clients.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="   bg-gray-200  ">
          <h2
            style={{ color: "#1B019B" }}
            className="text-3xl font-normal  ml-4 mb-2 "
          >
            <i className="fas fa-chalkboard-teacher"></i>
            &nbsp; Team members
          </h2>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        >
                          ...
                          <br />
                          <a
                            href="https://www.envicontrol.com/"
                            className="card-link"
                          >
                            Visit the website
                          </a>
